...
import 'package:quick_task/Screens/Dashboard/editTask.dart';
import 'addTask.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 47, 72, 116),
        centerTitle: true,
      ),
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'lib/assets/task_to_do2.jpg', // Correct asset path
